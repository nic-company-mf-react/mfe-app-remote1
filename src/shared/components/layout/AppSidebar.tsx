						...
						<>
							<div className="flex items-center gap-3 dark:hidden">
								...
								<div className="grid flex-1 text-left text-sm leading-tight">
									<span className="truncate font-medium text-gray-900">Multi MFE React v1</span>
									<span className="truncate text-xs text-gray-600">mfe-app-boilerplate(multirepo)</span>
								</div>
							</div>
							<div className="hidden dark:flex items-center gap-3">
								...
								<div className="grid flex-1 text-left text-sm leading-tight">
									<span className="truncate font-medium text-white">Multi MFE React v1</span>
									<span className="truncate text-xs text-gray-400">mfe-app-boilerplate(multirepo)</span>
								</div>
							</div>
						</>
					) : (
